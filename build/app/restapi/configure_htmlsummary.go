...
//go:generate swagger generate server --target ../../app --name Htmlsummary --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/htmlsummary/build/templates --principal interface{}

func configureFlags(api *operations.HtmlsummaryAPI) {
...
func configureAPI(api *operations.HtmlsummaryAPI) http.Handler {
